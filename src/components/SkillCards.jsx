            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4'>
                ...
                <div className="p-4  rounded-xl w-full hover:bg-[#00df9a] duration-300 group shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
                    ...
                    <div className="flex flex-col justify-start mt-4 mb-4 text-center">
                        ...
                        <p className="text-sm leading-10 dark:group-hover:text-black">I'm a E-Commercer</p>
                    </div>
                </div>
                ...
                <div className="p-4 rounded-xl w-full hover:bg-[#00df9a] duration-300 group shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
                    ...
                    <div className="flex flex-col justify-start mt-4 mb-4 text-center">
                        <p className="text-xl font-medium text-green-600 group-hover:text-black">Mobile application</p>
                        <p className="text-sm leading-10 dark:group-hover:text-black">I Develop Mobile application  </p>
                    </div>
                </div>
